...
from mmsegmentation.mmseg.apis import single_gpu_test
from mmsegmentation.mmseg.datasets import build_dataloader, build_dataset
from mmsegmentation.mmseg.models.segmentors.base import BaseSegmentor
from mmsegmentation.mmseg.ops import resize

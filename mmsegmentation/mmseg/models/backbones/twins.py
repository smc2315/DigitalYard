...
from mmsegmentation.mmseg.models.backbones.mit import EfficientMultiheadAttention
from mmsegmentation.mmseg.models.builder import BACKBONES
...
class GlobalSubsampledAttention(EfficientMultiheadAttention):
    ...
    which is a module from mmsegmentation.mmseg.models.backbones.mit.py.

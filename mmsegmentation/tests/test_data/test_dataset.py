...
from mmsegmentation.mmseg.core.evaluation import get_classes, get_palette
from mmsegmentation.mmseg.datasets import (DATASETS, ADE20KDataset, CityscapesDataset,
